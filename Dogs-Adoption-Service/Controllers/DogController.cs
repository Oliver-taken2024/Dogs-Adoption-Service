...
namespace Dogs_Adoption_Service.Controllers
{
    public class DogController : Controller
    {
        ...
        private static List<DogModel> dogs = new List<DogModel>
        {
            ...
            new DogModel { Id = 2, Name ="Mira", Cutness= 10,FavFood="Salami",FavToy="Squeky Toy",Temperment=5,IsAdopted=false},
            ...
            new DogModel { Id = 5, Name ="Gustave", Cutness= 9,FavFood="Liverpaste",FavToy="Plush Squirrel",Temperment=8,IsAdopted=false}
        };
